...
local utils = require "tired.themes.utils"
local nvapi = require "tired.themes.api"
...
map({ "i", "n" }, { "<cr>" }, function()
  ...
  local old_theme = require("tiredvim").base46.theme

  old_theme = '"' .. old_theme .. '"'
  require("tired.utils").replace_word(old_theme, '"' .. name .. '"')

  vim.schedule(function()
    require("volt.utils").close(state.close_opts)
  end)
