  ...
  home.packages = [
    (pkgs.writeShellApplication {
      ...
      text = ''
        ...
        # leenix:summary=Create a desktop launcher for a web app

        # leenix:args=[name url icon [custom-exec] [mime-types]]
        ...
        if [[ $ICON_REF =~ ^https?:// ]]; then
          ...
          if ! curl -fsSL -o "$ICON_PATH" "$ICON_REF" ||
             [[ ! -s $ICON_PATH ]]; then
        ...
        EXEC_COMMAND="''${CUSTOM_EXEC:-leenix-launch-webapp $APP_URL}"
