...

{
  home.packages = [
    (pkgs.writeShellApplication {
      name = "leenix-theme-set-templates";
      ...
      text = ''
        ...
        # leenix:summary=Generate themed config files from Leenix templates

        # leenix:hidden=true

        TEMPLATES_DIR="$LEENIX_PATH/default/themed"
        USER_TEMPLATES_DIR="$HOME/.config/leenix/themed"
        NEXT_THEME_DIR="$HOME/.config/leenix/current/next-theme"
