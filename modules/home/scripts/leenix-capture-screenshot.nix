...

{
  home.packages = [
    (pkgs.writeShellApplication {
      name = "leenix-capture-screenshot";
      excludeShellChecks = [ "SC1090" "SC2004" "SC2016" "SC2086" "SC2155" ];
      ...
      text = ''
        ...
        # leenix:args=[smart|region|windows|fullscreen] [slurp|copy|save] [--editor=]
        ...
        SCREENSHOT_EDITOR="''${LEENIX_SCREENSHOT_EDITOR:-satty}"
