...

{
  home.packages = [
    (pkgs.writeShellApplication {
      name = "leenix-menu-tmux-keybindings";
      ...
      text = ''
        ...
        # leenix:summary=Display annotated Tmux keybindings using an interactive search menu.

        # leenix:args=[--print|-p] [--config <path>]
        ...
        printf '%s\n' "$records" | walker --dmenu -p 'Tmux keybindings' --width 800 --height "$menu_height" >/dev/null || true
      '';
    })
  ];
}
