...

{
  home.packages = [
    (pkgs.writeShellApplication {
      name = "leenix-plymouth-set";
      excludeShellChecks = [ "SC2140" ];
      ...
      text = ''
        ...
        # leenix:summary=Set the Plymouth boot theme colors and logo

        # leenix:args=  <path-to-logo.png>

        # leenix:examples=leenix plymouth set '#1d2021' '#ebdbb2' ~/.config/leenix/current/theme/plymouth/logo.png
        ...
        if [[ $# -ne 3 ]]; then
          echo "Usage: leenix-plymouth-set   <path-to-logo.png>" >&2
          exit 1
        fi
        ...
        sddm_dir="/usr/share/sddm/themes/leenix"
        sddm_template="$HOME/.local/share/leenix/default/sddm/leenix/Main.qml"
