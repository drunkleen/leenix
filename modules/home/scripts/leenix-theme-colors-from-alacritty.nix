...

{
  home.packages = [
    (pkgs.writeShellApplication {
      name = "leenix-theme-colors-from-alacritty";
      ...
      text = ''
        ...
        # leenix:summary=Generate a theme's colors.toml from its alacritty.toml palette
        ...
        if [[ -z $THEME_SOURCE ]]; then
          echo "Usage: leenix-theme-colors-from-alacritty " >&2
          exit 1
        fi
