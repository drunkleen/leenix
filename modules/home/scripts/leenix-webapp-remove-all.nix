  ...
  home.packages = [
    (pkgs.writeShellApplication {
      ...
      text = ''
        ...
        # leenix:summary=Remove all web apps installed via leenix-webapp-install.
        ...
        while IFS= read -r -d ''' file; do
          if grep -qE "Exec=leenix-launch-webapp|Exec=leenix-webapp-handler" "$file" 2>/dev/null; then
