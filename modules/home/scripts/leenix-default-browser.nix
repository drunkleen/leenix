  ...
  home.packages = [
    (pkgs.writeShellApplication {
      ...
      text = ''
        ...
        # leenix:summary=Set the default browser for Leenix and XDG handlers

        # leenix:args=[chromium|chrome|brave|brave-origin|edge|firefox|zen]

        # leenix:examples=leenix default browser firefox | leenix default browser brave
        ...
        case "''${1:-}" in
          ...
          *)
            echo "Usage: leenix-default-browser <chromium|chrome|brave|brave-origin|edge|firefox|zen>"
            exit 1
            ;;
        esac
