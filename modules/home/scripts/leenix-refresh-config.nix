  ...
  home.packages = [
    (pkgs.writeShellApplication {
      ...
      text = ''
        ...
        # leenix:summary=Copies the named config from ~/.local/share/leenix/config/X/Y/Z -> ~/.config/X/Y/Z.
        ...
        To copy ~/.local/share/leenix/config/hypr/hyprlock.conf to ~/.config/hypr/hyprlock.conf
        ...
        default_config_file="''${HOME}/.local/share/leenix/config/$config_file"
        ...
        if [[ -f $user_config_file ]]; then
          ...
          if cmp -s "$user_config_file" "$backup_config_file"; then
            ...
            echo -e "\e[31mReplaced $user_config_file with new Leenix default.\nSaved backup as ''${backup_config_file}.\n\n\e[32mChanges:\e[0m"
