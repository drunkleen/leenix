  ...
  home.packages = [
    (pkgs.writeShellApplication {
      ...
      text = ''
        ...
        # leenix:summary=Install a supported development environment

        # leenix:name=dev-env

        # leenix:args=<ruby|node|bun|deno|go|laravel|symfony|php|python|elixir|phoenix|rust|java|zig|ocaml|dotnet|clojure|scala>

        # leenix:examples=leenix install dev-env ruby | leenix install dev-env node
        ...
        install_php() {
          leenix-pkg-add php composer php-sqlite xdebug
