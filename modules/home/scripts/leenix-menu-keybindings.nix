  ...
  home.packages = [
    (pkgs.writeShellApplication {
      ...
      text = ''
        ...
        # leenix:summary=Display Hyprland keybindings defined in your configuration using walker for an interactive search menu.
        ...
        #
        # Parses the plain `hyprctl binds` output rather than `hyprctl -j binds`:
        ...
        # - Remove standard Leenix bin path prefix
        # - Remove uwsm prefix
        ...
        dynamic_bindings() {
          ...
          function emit() {
            ...
            arg = f["arg"]
            sub(/~\/.local\/share\/leenix\/bin\//, "", arg)
            sub(/uwsm(-app| app) -- /, "", arg)
        ...
        prioritize_entries() {
          awk '
          {
            ...
            if (match(line, /Leenix menu/))  prio = 5
