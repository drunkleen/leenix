  ...
  home.packages = [
    (pkgs.writeShellApplication {
      ...
      text = ''
        ...
        # leenix:summary=Apply the current theme color to Chromium, Chrome, Edge, and Brave

        # leenix:hidden=true

        CHROMIUM_THEME=~/.config/leenix/current/theme/chromium.theme
        ...
        refresh_running_browser() {
          ...
          if leenix-cmd-present "$command" && pgrep $pgrep_args "$process" >/dev/null; then
