  ...
  home.packages = [
    (pkgs.writeShellApplication {
      ...
      text = ''
        ...
        # leenix:summary=Set the default editor for $EDITOR

        # leenix:args=[code|cursor|zed|sublime_text|helix|vim|emacs|nvim]

        # leenix:examples=leenix default editor | leenix default editor code | leenix default editor helix
        ...
        case "$1" in
          ...
          *)
            echo "Usage: leenix-default-editor <code|cursor|zed|sublime_text|helix|vim|emacs|nvim>"
            exit 1
            ;;
        esac
