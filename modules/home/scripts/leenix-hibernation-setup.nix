  ...
  home.packages = [
    (pkgs.writeShellApplication {
      ...
      text = ''
        ...
        # leenix:summary=Set up hibernation with swap and boot resume configuration

        # leenix:requires-sudo=true

        # leenix:args=[--force] [--no-rebuild]
        ...
        MKINITCPIO_CONF="/etc/mkinitcpio.conf.d/leenix_resume.conf"
        ...
        sudo cp -p "$LEENIX_PATH/default/systemd/system-sleep/keyboard-backlight" /usr/lib/systemd/system-sleep/
