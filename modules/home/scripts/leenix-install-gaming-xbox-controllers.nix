...

{
  home.packages = [
    (pkgs.writeShellApplication {
      name = "leenix-install-gaming-xbox-controllers";
      ...
      text = ''
        ...
        # leenix:summary=Install support for using Xbox controllers with Steam/RetroArch/etc.
        ...
        leenix-pkg-add linux-headers xpadneo-dkms
