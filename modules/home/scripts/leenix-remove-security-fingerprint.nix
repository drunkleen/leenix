...

{
  home.packages = [
    (pkgs.writeShellApplication {
      name = "leenix-remove-security-fingerprint";
      ...
      text = ''
        ...
        # leenix:summary=Remove fingerprint authentication from sudo, polkit, and lock screen
        ...
        leenix-pkg-drop fprintd libfprint-git
