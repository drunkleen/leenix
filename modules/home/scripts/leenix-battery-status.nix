  ...
  home.packages = [
    (pkgs.writeShellApplication {
      ...
      text = ''
        ...
        # leenix:summary=Returns a formatted battery status string with percentage and power draw/charge.
        ...
        time_remaining=$(leenix-battery-remaining-time)
        capacity=$(leenix-battery-capacity)
