...

{
  home.packages = [
    (pkgs.writeShellApplication {
      name = "leenix-setup-security-fingerprint";
      ...
      text = ''
        ...
        # leenix:summary=Set up fingerprint authentication for sudo, polkit, and lock screen
        ...
        add_hyprlock_fingerprint_icon() {
          ...
          sed -i 's/placeholder_text = .*/placeholder_text =  Enter Password 󰈷 <\/span>/' ~/.config/hypr/hyprlock.conf
        ...
        leenix-pkg-add libfprint-git fprintd usbutils
