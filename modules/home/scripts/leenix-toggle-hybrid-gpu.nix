        ...
        case "$gpu_mode" in
          ...
          "Hybrid")
            if gum confirm "Use only integrated GPU and reboot?"; then
              ...
              sudo cp -p $LEENIX_PATH/default/systemd/system-sleep/force-igpu /usr/lib/systemd/system-sleep/
              ...
              sudo cp -p $LEENIX_PATH/default/systemd/system/supergfxd.service.d/delay-start.conf /etc/systemd/system/supergfxd.service.d/
