...
local defaults = {
  ...
  TiredDashAscii = { fg = colors.cyan },
  TiredDashButtons = { fg = colors.light_grey },
  TiredDashFooter = { fg = colors.red },
}

-- merge statusline & hl_add tables!
local merge_tb = require("base46").merge_tb
local hexify_ColorStrs = require("base46").turn_str_to_color
return merge_tb(defaults, hexify_ColorStrs(require("tiredconfig").base46.hl_add))
