...
--- This is just a port for the tired.nvim theme engine: base46
...
local tiredconfig = require "tiredconfig"

if tiredconfig.ui.telescope.style == "bordered" or tiredconfig.base46.transparency then
...
if tiredconfig.ui.cmp.style == "default" then
  M.polish_hl.cmp = {
