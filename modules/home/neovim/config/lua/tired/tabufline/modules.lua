...
local txt = require("tired.tabufline.utils").txt
local btn = require("tired.tabufline.utils").btn
local strep = string.rep
local style_buf = require("tired.tabufline.utils").style_buf
local cur_buf = api.nvim_get_current_buf
local opts = require("tiredconfig").ui.tabufline
...
vim.cmd [[
  function! TbGoToBuf(bufnr,b,c,d)
    call luaeval('require("tired.tabufline").goto_buf(_A)', a:bufnr)
  endfunction]]

vim.cmd [[
  function! TbKillBuf(bufnr,b,c,d)
    call luaeval('require("tired.tabufline").close_buffer(_A)', a:bufnr)
  endfunction]]

vim.cmd "function! TbNewTab(a,b,c,d) \n tabnew \n endfunction"
vim.cmd "function! TbGotoTab(tabnr,b,c,d) \n execute a:tabnr ..'tabnext' \n endfunction"
vim.cmd "function! TbCloseAllBufs(a,b,c,d) \n lua require('tired.tabufline').closeAllBufs() \n endfunction"
