...
M.replace_word = function(old, new, filepath)
  filepath = filepath or vim.fn.stdpath "config" .. "/lua/" .. "tiredvim.lua"
...
M.reload = function(module)
  ...
  require("plenary.reload").reload_module "tiredconfig"
  require("plenary.reload").reload_module "tiredvim"
  require("plenary.reload").reload_module "base46"
  require("plenary.reload").reload_module "tired"
